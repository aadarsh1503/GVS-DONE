...
const ServiceDifferentiators = () => {
  return (
    <div className="text-center min-h-screen py-32 p-8 font-sans">
      <h1 className="text-4xl font-bold text-black mb-32">eCOMMERCE MANAGED SERVICES – OUR DIFFERENTIATORS</h1>
